 ...
 class JsonDisplayMarker {
    function getMarkers(){
        ...
        try{
            ...
            $queryMarker = "SELECT formkajian.id_kajian, formkajian.namakajian, formkajian.lat, formkajian.lng, username.username FROM formkajian INNER JOIN username ON formkajian.id_username = username.id_username WHERE formkajian.statuskajian='aktif'";
