...
?>
<?php echo "<script>console.log('NAMA ".$nama."');</script>"; ?>
<!DOCTYPE html>
<html>
<head>
	<title>Maps Bencana - Admin</title>
...
<!-- kalau ada kalimat terputus jgn lupa petik 2 -->
									<div class="form-group">
									...
									<button type="submit" class="btn btn-primary" name="EditAdmin" onclick="return(validate());">Submit Button</button>
